    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('compound_frequency', models.CharField(choices=[('M', 'Monthly'), ('Q', 'Quarterly'), ('A', 'Annually')], default='M', max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('LP', 'Loan Provider'), ('LC', 'Loan Customer'), ('BP', 'Bank Personnel')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.DecimalField(decimal_places=2, max_digits=15, validators=[django.core.validators.MinValueValidator(1000)])),
                ('status', models.CharField(choices=[('P', 'Pending'), ('A', 'Approved'), ('R', 'Rejected')], default='P', max_length=1)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('provider', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='loans.user')),
            ],
        ),
        migrations.AddField(
            model_name='loan',
            name='customer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='loans.user'),
        ),
    ]
